...
namespace apbd_tutorial08.Context;

public partial class Apbd08Context : DbContext
{
    private readonly string? _connectionString;
    public Apbd08Context()
    {
    }

    public Apbd08Context(IConfiguration configuration, DbContextOptions<Apbd08Context> options)
        : base(options)
    {
